package edu.cs4730.contentprosqlitedbdemo_kt.db
...
class mySQLiteHelper  //required constructor with the super.
    ...
    companion object {
        ...
        const val KEY_ROWID: String = "_id" //required field for the cursorAdapter

        const val DATABASE_NAME: String = "myScore.db"
        const val TABLE_NAME: String = "HighScore"
