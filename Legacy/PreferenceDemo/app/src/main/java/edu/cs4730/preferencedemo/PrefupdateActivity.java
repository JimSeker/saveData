 ...
 *   if it's below honeycomb (API 14) then it update the summary fields with the answer the user picked.
 *      Note, the fragment will also update the summary screen as well.
 *
 */
