...
import edu.cs4730.sqlitedbviewmodeldemo.databinding.RecyclerRowBinding;
import edu.cs4730.sqlitedbviewmodeldemo.db.mySQLiteHelper;
...
public class myAdapter extends RecyclerView.Adapter<myAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.viewBinding.name.setText(mCursor.getString(mCursor.getColumnIndex(mySQLiteHelper.KEY_NAME)));
        viewHolder.viewBinding.score.setText(String.valueOf(mCursor.getInt(mCursor.getColumnIndex(mySQLiteHelper.KEY_SCORE))));
